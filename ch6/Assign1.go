...
func MakePerson(firstName, lastName string, age int) PersonInfo {
	return PersonInfo{FirstName: firstName, LastName: lastName, Age: age}
}
func MakePersonPointer(firstName, lastName string, age int) *PersonInfo {
	return &PersonInfo{FirstName: firstName, LastName: lastName, Age: age}
}
